...
from parser_02_scrapingclub_com.tools.check_time import check_time
from parser_02_scrapingclub_com.tools.utils import change_user_agent, get_full_url_domain_name, write_to_json
...
def get_link_to_card(headers: dict, full_url_domain_name: str, url_site: str, ):
    ...
    for page_number in range(1, 7):
        ...
        num_cards = len(list(product_cards))

        with tqdm(total=num_cards, unit="card", desc=f"Page number {page_number}", colour='green') as progress_bar:
